...
namespace WS_Actas
{
    ...
    public interface IServiceProyectos
    {
        ...
        [OperationContract]
        [WebInvoke(Method = "GET", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "ObtenerActasPorProyecto/{idProyecto}")]
        List<Acta> ObtenerActasPorProyecto(string idProyecto);
    }    
}
